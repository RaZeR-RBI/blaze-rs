...
impl<'a> Shader<'a> {
    ...
    pub fn set_uniform_matrix_2fv(location: UniformLoc, count: i32, transpose: bool, value: &[f32]) {
        unsafe {
            BLZ_UniformMatrix2fv(location, count, transpose as u8, value.as_ptr());
        }
    }
    pub fn set_uniform_matrix_3fv(location: UniformLoc, count: i32, transpose: bool, value: &[f32]) {
        unsafe {
            BLZ_UniformMatrix3fv(location, count, transpose as u8, value.as_ptr());
        }
    }
    pub fn set_uniform_matrix_4fv(location: UniformLoc, count: i32, transpose: bool, value: &[f32]) {
        unsafe {
            BLZ_UniformMatrix4fv(location, count, transpose as u8, value.as_ptr());
        }
    }
    pub fn set_uniform_matrix_2x3fv(location: UniformLoc, count: i32, transpose: bool, value: &[f32]) {
        unsafe {
            BLZ_UniformMatrix2x3fv(location, count, transpose as u8, value.as_ptr());
        }
    }
    pub fn set_uniform_matrix_3x2fv(location: UniformLoc, count: i32, transpose: bool, value: &[f32]) {
        unsafe {
            BLZ_UniformMatrix3x2fv(location, count, transpose as u8, value.as_ptr());
        }
    }
    pub fn set_uniform_matrix_2x4fv(location: UniformLoc, count: i32, transpose: bool, value: &[f32]) {
        unsafe {
            BLZ_UniformMatrix2x4fv(location, count, transpose as u8, value.as_ptr());
        }
    }
    pub fn set_uniform_matrix_4x2fv(location: UniformLoc, count: i32, transpose: bool, value: &[f32]) {
        unsafe {
            BLZ_UniformMatrix4x2fv(location, count, transpose as u8, value.as_ptr());
        }
    }
    pub fn set_uniform_matrix_3x4fv(location: UniformLoc, count: i32, transpose: bool, value: &[f32]) {
        unsafe {
            BLZ_UniformMatrix3x4fv(location, count, transpose as u8, value.as_ptr());
        }
    }
    pub fn set_uniform_matrix_4x3fv(location: UniformLoc, count: i32, transpose: bool, value: &[f32]) {
        unsafe {
